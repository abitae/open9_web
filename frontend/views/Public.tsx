            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="contact-name" className="text-sm font-black text-slate-700 uppercase ml-2">Nombre</label>
                  <input id="contact-name" type="text" value={name} onChange={e => setName(e.target.value)} className="w-full p-5 bg-slate-50 border border-slate-100 rounded-2xl font-bold focus:border-[#4fd1c5] outline-none" placeholder="Tu nombre" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="contact-company" className="text-sm font-black text-slate-700 uppercase ml-2">Empresa</label>
                  <input id="contact-company" type="text" value={company} onChange={e => setCompany(e.target.value)} className="w-full p-5 bg-slate-50 border border-slate-100 rounded-2xl font-bold focus:border-[#4fd1c5] outline-none" placeholder="Tu compañía" />
                </div>
              </div>
              <div className="space-y-2">
                <label htmlFor="contact-subject" className="text-sm font-black text-slate-700 uppercase ml-2">Asunto</label>
                <input id="contact-subject" type="text" value={subject} onChange={e => setSubject(e.target.value)} className="w-full p-5 bg-slate-50 border border-slate-100 rounded-2xl font-bold focus:border-[#4fd1c5] outline-none" placeholder="¿Cómo podemos ayudarte?" />
              </div>
              <div className="space-y-2">
                <label htmlFor="contact-body" className="text-sm font-black text-slate-700 uppercase ml-2">Mensaje</label>
                <textarea id="contact-body" value={body} onChange={e => setBody(e.target.value)} className="w-full p-5 bg-slate-50 border border-slate-100 rounded-2xl font-bold focus:border-[#4fd1c5] outline-none" rows={6} placeholder="Cuéntanos sobre tu proyecto..."></textarea>
              </div>
              {status === 'success' && <p className="text-green-600 font-bold" role="status">Mensaje enviado correctamente.</p>}
              {status === 'error' && errorMessage && <p className="text-red-500 font-bold" role="alert" id="contact-error">{errorMessage}</p>}
        ...
        <div className="bg-slate-50 p-10 md:p-16 rounded-[3.5rem] border border-slate-100 shadow-xl">
          ...
          {step === 3 && (
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="inquiry-clientName" className="text-sm font-black text-slate-700 uppercase ml-2">Nombre Completo</label>
                  <input
                    id="inquiry-clientName"
                    type="text"
                ...
                <div className="space-y-2">
                  <label htmlFor="inquiry-company" className="text-sm font-black text-slate-700 uppercase ml-2">Empresa / Organización</label>
                  <input
                    id="inquiry-company"
                    type="text"
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="inquiry-clientEmail" className="text-sm font-black text-slate-700 uppercase ml-2">Email Corporativo</label>
                  <input
                    id="inquiry-clientEmail"
                    type="email"
                  ...
                  />
                  {errors.email && <p id="inquiry-email-error" className="text-red-500 text-xs font-bold flex items-center gap-1 mt-1" role="alert"><AlertCircle size={12}/> {errors.email}</p>}
                </div>
                <div className="space-y-2">
                  <label htmlFor="inquiry-clientPhone" className="text-sm font-black text-slate-700 uppercase ml-2">Teléfono (9 dígitos)</label>
                  <input
                    id="inquiry-clientPhone"
                    type="tel"
                  ...
                  />
                  {errors.phone && <p id="inquiry-phone-error" className="text-red-500 text-xs font-bold flex items-center gap-1 mt-1" role="alert"><AlertCircle size={12}/> {errors.phone}</p>}
                </div>
              </div>
          ...
          {step === 4 && (
            <div className="space-y-8">
              ...
              <label htmlFor="inquiry-description" className="sr-only">Descripción del proyecto</label>
              <textarea
